...
export const cardTemplates: CardTemplate[] = [
  ...
  },
  {
    ...
    perks: [
      ...
      { id: 'ue-rideshare-credit', name: '$60 Rideshare Credit', description: 'Enroll to receive up to $5 back each month on rideshare purchases, up to $60 each calendar year; yearly opt-in required', category: 'rideshare-credit', annualValue: 60, renewalPeriod: 'annual', periodValue: 5, requiresEnrollment: true },
  ...
  // ─── CHASE MARRIOTT BONVOY FAMILY (US CONSUMER) ────────────
  {
    ...
    perks: [
      ...
      { id: 'mbb-payback', name: 'Pay Yourself Back', description: 'Redeem Marriott Bonvoy points for statement credits covering qualifying travel purchases made directly with airlines or at participating Marriott hotels, up to $750 total redemptions per year', category: 'travel-credit', annualValue: 750, renewalPeriod: 'annual' },
    ],
  },
  {
