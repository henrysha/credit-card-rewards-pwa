...
export const cardTemplates: CardTemplate[] = [
  // ─── CHASE ─────────────────────────────────────────────────
  {
    ...
    earningRates: [
      ...
      { category: 'Gas & EV Charging', multiplier: 3 },
      { category: 'Vacation Rentals', multiplier: 3 },
      { category: 'Other Travel', multiplier: 2 },
      { category: 'All Other', multiplier: 1 },
    ],
    perks: [
      { id: 'csp-hotel-credit', name: '$100 Hotel Credit', description: 'Annual hotel credit for stays booked through Chase Travel', category: 'hotel-credit', annualValue: 100, renewalPeriod: 'annual' },
      { id: 'csp-ge-tsa', name: '$120 Global Entry/TSA PreCheck', description: 'Statement credit for GE/TSA/NEXUS application fee every 4 years', category: 'global-entry-tsa', annualValue: 30, renewalPeriod: 'every-4-years' },
      { id: 'csp-apple-tv', name: 'Apple TV+ Subscription', description: 'Complimentary one-year Apple TV+ subscription (activate by 12/31/2026)', category: 'streaming-credit', annualValue: 120, renewalPeriod: 'one-time', expirationDate: '2026-12-31', requiresEnrollment: true },
      ...
      { id: 'csp-doordash-credit', name: '$10 DoorDash Credit', description: 'Monthly $10 promo credit for grocery, convenience, or other non-restaurant orders (through 12/31/2027)', category: 'delivery-credit', annualValue: 120, renewalPeriod: 'monthly', periodValue: 10, expirationDate: '2027-12-31', requiresEnrollment: true },
      { id: 'csp-evacuation-insurance', name: 'Emergency Evacuation & Transportation', description: 'Up to $100,000 for emergency medical evacuation and transportation', category: 'insurance', annualValue: 0, renewalPeriod: 'ongoing' },
  ...
  },
  {
    ...
    perks: [
      ...
      { id: 'csr-restaurant-doordash', name: '$5 DoorDash Restaurant Credit', description: 'Monthly $5 restaurant promo credit (through 12/31/2027)', category: 'delivery-credit', annualValue: 60, renewalPeriod: 'monthly', periodValue: 5, expirationDate: '2027-12-31', requiresEnrollment: true },
      { id: 'csr-grocery-doordash-1', name: '$10 DoorDash Grocery Credit (1)', description: 'Monthly $10 grocery/retail promo credit (through 12/31/2027)', category: 'delivery-credit', annualValue: 120, renewalPeriod: 'monthly', periodValue: 10, expirationDate: '2027-12-31', requiresEnrollment: true },
      { id: 'csr-grocery-doordash-2', name: '$10 DoorDash Grocery Credit (2)', description: 'Monthly $10 grocery/retail promo credit (through 12/31/2027)', category: 'delivery-credit', annualValue: 120, renewalPeriod: 'monthly', periodValue: 10, expirationDate: '2027-12-31', requiresEnrollment: true },
  ...
  // ─── AMEX ──────────────────────────────────────────────────
  {
    ...
    perks: [
      { id: 'ag-dining', name: '$120 Dining Credits', description: '$10/month at Grubhub, Cheesecake Factory, Goldbelly, Wine.com, Five Guys', details: 'Amex Dining Credits can be used at specific platforms like Grubhub or select Restaurants.', usageLink: 'https://global.americanexpress.com/card-benefits/detail/dining-credit/gold', category: 'dining-credit', annualValue: 120, renewalPeriod: 'monthly', periodValue: 10, requiresEnrollment: true },
  ...
  // ─── CITI CO-BRANDED ───────────────────────────────────────
  {
    ...
    annualFee: 595,
    color: '#003b70',
    signupBonus: { points: 70000, spend: 7000, timeMonths: 3, unit: 'miles' },
    earningRates: [
      { category: 'Car Rentals & Hotels (AA)', multiplier: 10 },
      { category: 'American Airlines', multiplier: 4 },
      { category: 'All Other', multiplier: 1 },
    ],
    perks: [
      { id: 'aa-exec-lounge', name: 'Admirals Club® Membership', description: 'Full membership for primary and authorized users', category: 'lounge-access', annualValue: 650, renewalPeriod: 'annual' },
      { id: 'aa-exec-checked-bag', name: 'First Checked Bag Free', description: 'For you and up to 8 companions', category: 'travel-credit', annualValue: 0, renewalPeriod: 'ongoing' },
      { id: 'aa-exec-boarding', name: 'Enhanced Airport Experience', description: 'Priority check-in and boarding (Group 4)', category: 'other', annualValue: 0, renewalPeriod: 'ongoing' },
      { id: 'aa-exec-ge-tsa', name: 'Global Entry/TSA PreCheck', description: 'Statement credit every 4 years', category: 'global-entry-tsa', annualValue: 30, renewalPeriod: 'every-4-years' },
    ],
  },
  {
    ...
    firstYearFeeWaived: true,
    color: '#003b70',
    signupBonus: { points: 50000, spend: 2500, timeMonths: 3, unit: 'miles' },
    earningRates: [
  ...
  },
  {
    ...
    annualFee: 0,
    color: '#003b70',
    signupBonus: { points: 15000, spend: 500, timeMonths: 3, unit: 'miles' },
    earningRates: [
      { category: 'American Airlines', multiplier: 2 },
    ...
    perks: [
      { id: 'aa-mileup-savings', name: '25% Inflight Savings', description: 'On food and beverage', category: 'other', annualValue: 0, renewalPeriod: 'ongoing' },
    ],
  },
  {
    ...
    color: '#003b70',
    isBusinessCard: true,
    signupBonus: { points: 75000, spend: 5000, timeMonths: 5, unit: 'miles' },
    earningRates: [
      { category: 'American Airlines', multiplier: 2 },
      { category: 'Telecommunications', multiplier: 2 },
      { category: 'Cable/Satellite TV', multiplier: 2 },
      { category: 'Car Rentals', multiplier: 2 },
      { category: 'Gas Stations', multiplier: 2 },
      { category: 'All Other', multiplier: 1 },
    ],
    perks: [
  ...
  },
  {
    ...
    annualFee: 350,
    color: '#003b70',
    signupBonus: { points: 60000, spend: 4000, timeMonths: 3, unit: 'miles' },
    earningRates: [
      { category: 'AAdvantage Hotels™', multiplier: 6 },
      { category: 'American Airlines', multiplier: 3 },
      { category: 'Restaurants', multiplier: 2 },
      { category: 'Rides and Rails™', multiplier: 2 },
      { category: 'All Other', multiplier: 1 },
    ],
    perks: [
      { id: 'aa-globe-lounge', name: '4 Admirals Club® Passes', description: 'Four 24-hour passes annually', category: 'lounge-access', annualValue: 300, renewalPeriod: 'annual' },
      { id: 'aa-globe-checked-bag', name: 'First Checked Bag Free', description: 'For you and up to 8 companions', category: 'travel-credit', annualValue: 0, renewalPeriod: 'ongoing' },
      { id: 'aa-globe-boarding', name: 'Preferred Boarding', description: 'Board in Group 5', category: 'other', annualValue: 0, renewalPeriod: 'ongoing' },
      { id: 'aa-globe-inflight', name: '$100 Inflight Credit', description: 'Annual credit for food, beverage, and Wi-Fi', category: 'other', annualValue: 100, renewalPeriod: 'annual' },
      { id: 'aa-globe-turo', name: '$240 Turo Credit', description: '$30 credit for up to 8 Turo trips annually', category: 'rideshare-credit', annualValue: 240, renewalPeriod: 'annual' },
      { id: 'aa-globe-splurge', name: '$100 Annual Splurge Credit℠', description: 'For select brands including AAdvantage Hotels™', category: 'other', annualValue: 100, renewalPeriod: 'annual' },
      { id: 'aa-globe-companion', name: 'Companion Certificate', description: 'After renewal each year', category: 'companion-certificate', annualValue: 0, renewalPeriod: 'annual' },
