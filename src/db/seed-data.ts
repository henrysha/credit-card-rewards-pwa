...
export const cardTemplates: CardTemplate[] = [
  // ─── CHASE ─────────────────────────────────────────────────
  {
    ...
    perks: [
      ...
      { id: 'csp-dashpass', name: 'DashPass 6-Month Trial', description: 'Complimentary 6-month DashPass membership for DoorDash', category: 'membership', annualValue: 60, renewalPeriod: 'one-time' },
  ...
  },
  {
    ...
    perks: [
      ...
      { id: 'csr-doordash-promo', name: '$300 DoorDash Credits', description: '$25/mo in DoorDash promos: $5 restaurant + 2×$10 grocery/retail (through 12/31/2027)', category: 'delivery-credit', annualValue: 300, renewalPeriod: 'monthly', periodValue: 25, expirationDate: '2027-12-31' },
      ...
      { id: 'csr-instacart', name: '$120 Instacart Credit', description: '$10/month Instacart credit + 3-mo Instacart+ (starting 5/1/2025, through 12/31/2027)', category: 'delivery-credit', annualValue: 120, renewalPeriod: 'monthly', periodValue: 10, expirationDate: '2027-12-31', requiresEnrollment: true },
