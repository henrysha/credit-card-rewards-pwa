Feature: Perk Expiry Notifications
  ...
  Scenario: Urgency badge shows on perks expiring soon
    ...
    And a perk "$120 Lyft Credit" is set to expire in 2 days
    When I navigate to the "Perks"
    Then I should see an urgency badge on "$120 Lyft Credit"

  Scenario: Warning badge shows on perks expiring within a week
    Given I have added the "Chase Sapphire Reserve" card
    And a perk "$120 Lyft Credit" is set to expire in 5 days
    When I navigate to the "Perks"
    Then I should see a warning badge on "$120 Lyft Credit"
  ...
  Scenario: Perk expiring today shows "Expires today" badge
    Given I have added the "Chase Sapphire Reserve" card
    And a perk "$120 Lyft Credit" is set to expire in 0 days
    When I navigate to the "Perks"
    Then I should see "Expires today" badge on "$120 Lyft Credit"
  ...
  Scenario: Push notification is triggered when perks are expiring soon
    ...
    Then I should see a push notification "⚠️ Perks Expiring Soon" containing "$120 Lyft Credit"
