...
export const cardTemplates: CardTemplate[] = [
  ...
  },
  {
    ...
    perks: [
      { id: 'cff-quarterly-rotation', name: '5% Quarterly Rotating Categories', description: 'Activate each quarter to earn 5% cash back on up to $1,500 in combined bonus-category purchases.', details: 'Categories change every calendar quarter. Check Chase for the current categories, exclusions, and activation deadline. Activate with Chase first, then mark this perk activated here; this app only tracks your confirmation. Earn up to $75 total cash back on eligible quarterly spending, then 1% after the cap. This is a spending-based reward, not a statement credit.', usageLink: 'https://www.chase.com/personal/credit-cards/freedom/freedomfive', category: 'other', annualValue: 0, renewalPeriod: 'quarterly', requiresEnrollment: true, requiresEnrollmentEachPeriod: true, rewardLabel: '5%' },
  ...
  },
  {
    ...
    perks: [
      { id: 'cf-quarterly-rotation', name: '5% Quarterly Rotating Categories', description: 'Activate each quarter to earn 5% cash back on up to $1,500 in combined bonus-category purchases.', details: 'Categories change every calendar quarter. Check Chase for the current categories, exclusions, and activation deadline. Activate with Chase first, then mark this perk activated here; this app only tracks your confirmation. Earn up to $75 total cash back on eligible quarterly spending, then 1% after the cap. This is a spending-based reward, not a statement credit.', usageLink: 'https://www.chase.com/personal/credit-cards/freedom/freedomfive', category: 'other', annualValue: 0, renewalPeriod: 'quarterly', requiresEnrollment: true, requiresEnrollmentEachPeriod: true, rewardLabel: '5%' },
